...
export default function GoodsTransfer(props) {
    ...
    const submitFormHandler = (e) => {
        ...
        const deliveryDocument = {
            warehouse_id: form.goodsTransferToWarehouse.value,
            from_warehouse_id: form.goodsTransferFromWarehouse.value,
        ...
        falconAPI.post('/inventoryTransaction/add', { transactionType: 'Goods Transfer', deliveryDocument, items, prices })
            .then(response => {
                setLoading(prevLoading => false);
                setSubmitStatus({
                    submitted: true,
            ...
            <GridItem xs={12} sm={12} md={12}>
                <Card>
                    ...
                    <CardBody>
                        ...
                        <Button onClick={submitFormHandler}>Issue Goods Transfer</Button>
                    </CardBody>
                </Card>
            </GridItem>
        </GridContainer>
